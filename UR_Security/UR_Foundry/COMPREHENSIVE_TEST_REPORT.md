...
- `test/ChaosMemePriva.t.sol` - UnrugableToken unit tests (4 tests)
- `test/UR_Factory.t.sol` - UR_Factory unit and fuzz tests (10 tests)
- `test/UnrugableTokenInvariants.t.sol` - Token invariant tests (3 invariants)
- `test/UR_FactoryInvariants.t.sol` - Factory invariant tests (5 invariants)
- `test/UnRugable.sol` - UnrugableToken contract
- `test/UR_Factory.sol` - UnrugableToken + UR_Factory contracts
